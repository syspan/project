using Agendo.Model;
using System.Linq;
using Agendo.Repository;

namespace Agendo.Dal
{
    public class ServicePersistor
    {
        AgendoManagerContext _Context;

        public ServicePersistor()
        {
            _Context = new AgendoManagerContext();
            //System.Threading.Thread.Sleep(5000); 
        }

        public IQueryable<Service> GetServices(out int totalRecords)
        {
