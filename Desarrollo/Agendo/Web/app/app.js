...
define(['agendoApp/services/routeResolver'], function () {

    var app = angular.module('agendoApp', ['ngRoute', 'ngAnimate', 'routeResolverServices',
    ...
    app.config(['$routeProvider', 'routeResolverProvider', '$controllerProvider',
        ...
        function ($routeProvider, routeResolverProvider, $controllerProvider,
            ...
            $routeProvider
                ...
                //.when('/customers', route.resolve('services', 'services/', 'vm'))
                ...
                .when('/servicios', route.resolve('services', 'services/', 'vm'))
               //.when('/about', route.resolve('About', '', 'vm'))
